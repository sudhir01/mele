...
public class Message implements org.apache.mele.thirdparty.thrift_0_9_0.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.mele.thirdparty.thrift_0_9_0.protocol.TStruct STRUCT_DESC = new org.apache.mele.thirdparty.thrift_0_9_0.protocol.TStruct("Message");

  private static final org.apache.mele.thirdparty.thrift_0_9_0.protocol.TField ID_FIELD_DESC = new org.apache.mele.thirdparty.thrift_0_9_0.protocol.TField("id", org.apache.mele.thirdparty.thrift_0_9_0.protocol.TType.STRING, (short)1);
  private static final org.apache.mele.thirdparty.thrift_0_9_0.protocol.TField MESSAGE_FIELD_DESC = new org.apache.mele.thirdparty.thrift_0_9_0.protocol.TField("message", org.apache.mele.thirdparty.thrift_0_9_0.protocol.TType.STRING, (short)2);
  ...
  static {
    ...
    tmpMap.put(_Fields.ID, new org.apache.mele.thirdparty.thrift_0_9_0.meta_data.FieldMetaData("id", org.apache.mele.thirdparty.thrift_0_9_0.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.mele.thirdparty.thrift_0_9_0.meta_data.FieldMetaData.addStructMetaDataMap(Message.class, metaDataMap);
  }
  ...
  public Message(Message other) {
    if (other.isSetId()) {
      this.id = org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.copyBinary(other.id);
;
    }
    if (other.isSetMessage()) {
      this.message = org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.copyBinary(other.message);
;
    }
  }
  ...
  public byte[] getId() {
    setId(org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.rightSize(id));
  ...
  public Message setId(ByteBuffer id) {
    this.id = id;
    return this;
  }
  ...
  public byte[] getMessage() {
    setMessage(org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.rightSize(message));
  ...
  public int compareTo(Message other) {
    ...
    if (isSetId()) {
      lastComparison = org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.compareTo(this.id, typedOther.id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (this.id == null) {
      ...
      org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.toString(this.id, sb);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("message:");
    if (this.message == null) {
      ...
      org.apache.mele.thirdparty.thrift_0_9_0.TBaseHelper.toString(this.message, sb);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class MessageStandardScheme extends StandardScheme<Message> {
    ...
    public void read(org.apache.mele.thirdparty.thrift_0_9_0.protocol.TProtocol iprot, Message struct) throws org.apache.mele.thirdparty.thrift_0_9_0.TException {
    ...
    public void write(org.apache.mele.thirdparty.thrift_0_9_0.protocol.TProtocol oprot, Message struct) throws org.apache.mele.thirdparty.thrift_0_9_0.TException {
      struct.validate();
  ...
  private static class MessageTupleScheme extends TupleScheme<Message> {
    ...
    @Override
    public void write(org.apache.mele.thirdparty.thrift_0_9_0.protocol.TProtocol prot, Message struct) throws org.apache.mele.thirdparty.thrift_0_9_0.TException {
    ...
    @Override
    public void read(org.apache.mele.thirdparty.thrift_0_9_0.protocol.TProtocol prot, Message struct) throws org.apache.mele.thirdparty.thrift_0_9_0.TException {
